...
FOUNDATION_EXPORT UIImage *WM_SDScaledImageForKey(NSString *key, UIImage *image);

typedef void(^WM_SDWebImageNoParamsBlock)(void);

FOUNDATION_EXPORT NSString *const WM_SDWebImageErrorDomain;
