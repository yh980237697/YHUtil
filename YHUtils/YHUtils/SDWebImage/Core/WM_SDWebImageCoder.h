 ...
 */
FOUNDATION_EXPORT NSString * _Nonnull const WM_SDWebImageCoderScaleDownLargeImagesKey;
 ...
 */
CG_EXTERN CGColorSpaceRef _Nonnull WM_SDCGColorSpaceGetDeviceRGB(void);
 ...
 */
CG_EXTERN BOOL WM_SDCGImageRefContainsAlpha(_Nullable CGImageRef imageRef);
 ...
 */
@protocol WM_SDWebImageCoder <NSObject>
 ...
 */
- (nullable NSData *)encodedDataWithImage:(nullable UIImage *)image format:(WM_SDImageFormat)format;
...
/**
 ...
 @note Pay attention that these methods are not called from main queue.
 */
@protocol WM_SDWebImageProgressiveCoder <WM_SDWebImageCoder>
