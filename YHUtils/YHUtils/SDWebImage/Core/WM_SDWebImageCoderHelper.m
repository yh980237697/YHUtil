...
@implementation WM_SDWebImageCoderHelper

+ (UIImage *)animatedImageWithFrames:(NSArray<WM_SDWebImageFrame *> *)frames {
    ...
    [frames enumerateObjectsUsingBlock:^(WM_SDWebImageFrame * _Nonnull frame, NSUInteger idx, BOOL * _Nonnull stop) {
    ...
    CFStringRef imageUTType = [NSData wm_UTTypeFromSDImageFormat:SDImageFormatGIF];
...
+ (NSArray<WM_SDWebImageFrame *> *)framesFromAnimatedImage:(UIImage *)animatedImage {
    if (!animatedImage) {
        return nil;
    }
    ...
    [animatedImages enumerateObjectsUsingBlock:^(UIImage * _Nonnull image, NSUInteger idx, BOOL * _Nonnull stop) {
        ...
        if ([image isEqual:previousImage]) {
            ...
            WM_SDWebImageFrame *frame = [WM_SDWebImageFrame frameWithImage:previousImage duration:avgDuration * repeatCount];
