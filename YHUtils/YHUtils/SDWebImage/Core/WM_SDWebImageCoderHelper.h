...
@interface WM_SDWebImageCoderHelper : NSObject
 ...
 */
+ (UIImage * _Nullable)animatedImageWithFrames:(NSArray<WM_SDWebImageFrame *> * _Nullable)frames;
 ...
 */
+ (NSArray<WM_SDWebImageFrame *> * _Nullable)framesFromAnimatedImage:(UIImage * _Nullable)animatedImage;
