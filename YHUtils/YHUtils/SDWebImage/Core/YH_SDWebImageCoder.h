 ...
 */
FOUNDATION_EXPORT NSString * _Nonnull const YH_SDWebImageCoderScaleDownLargeImagesKey;
 ...
 */
CG_EXTERN CGColorSpaceRef _Nonnull YH_SDCGColorSpaceGetDeviceRGB(void);
 ...
 */
CG_EXTERN BOOL YH_SDCGImageRefContainsAlpha(_Nullable CGImageRef imageRef);
 ...
 */
@protocol YH_SDWebImageCoder <NSObject>
 ...
 */
- (nullable NSData *)encodedDataWithImage:(nullable UIImage *)image format:(YH_SDImageFormat)format;
...
/**
 ...
 @note Pay attention that these methods are not called from main queue.
 */
@protocol YH_SDWebImageProgressiveCoder <YH_SDWebImageCoder>
