...
@implementation YH_SDWebImageCoderHelper

+ (UIImage *)animatedImageWithFrames:(NSArray<YH_SDWebImageFrame *> *)frames {
    ...
    [frames enumerateObjectsUsingBlock:^(YH_SDWebImageFrame * _Nonnull frame, NSUInteger idx, BOOL * _Nonnull stop) {
    ...
    CFStringRef imageUTType = [NSData yh_UTTypeFromSDImageFormat:SDImageFormatGIF];
...
+ (NSArray<YH_SDWebImageFrame *> *)framesFromAnimatedImage:(UIImage *)animatedImage {
    if (!animatedImage) {
        return nil;
    }
    ...
    [animatedImages enumerateObjectsUsingBlock:^(UIImage * _Nonnull image, NSUInteger idx, BOOL * _Nonnull stop) {
        ...
        if ([image isEqual:previousImage]) {
            ...
            YH_SDWebImageFrame *frame = [YH_SDWebImageFrame frameWithImage:previousImage duration:avgDuration * repeatCount];
