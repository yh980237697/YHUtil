...
FOUNDATION_EXPORT UIImage *YH_SDScaledImageForKey(NSString *key, UIImage *image);

typedef void(^YH_SDWebImageNoParamsBlock)(void);

FOUNDATION_EXPORT NSString *const YH_SDWebImageErrorDomain;
