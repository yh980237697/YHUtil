...
@interface YH_SDWebImageCoderHelper : NSObject
 ...
 */
+ (UIImage * _Nullable)animatedImageWithFrames:(NSArray<YH_SDWebImageFrame *> * _Nullable)frames;
 ...
 */
+ (NSArray<YH_SDWebImageFrame *> * _Nullable)framesFromAnimatedImage:(UIImage * _Nullable)animatedImage;
