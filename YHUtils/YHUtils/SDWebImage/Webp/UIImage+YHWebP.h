 ...
 * @deprecated use `yh_imageLoopCount` instead.
 */
- (NSInteger)yh_webpLoopCount __deprecated_msg("Method deprecated. Use `yh_imageLoopCount` in `UIImage+MultiFormat.h`");
